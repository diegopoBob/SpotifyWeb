            ...
            <div class="flex flex-col items-center md:justify-center px-6 pt-16 md:py-8 mx-auto h-screen">
                ...
                <div class="z-10 w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="asd" method="POST">
                            <div>
                                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ingrese su nickname o usuario</label>
                            ...
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                No tiene su cuenta aún? <a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Registrese</a>
                            </p>
                        </form>
                    </div>
                </div>

        ...
        <div name="divPlay" id="divPLaylistPrincipal" class=" text-white w-full  rounded flex"> 
            ...
            <div class="mt-5">
                <div  name="textoLibreria" class="h-2/3 flex flex-col justify-center overflow-hidden">
                    <h4>Playlist <%= tipo %></h4>
                    <h2 style="font-size: clamp(20px, 6vw, 110px);" class=" Class leading-none font-bold "><%= titulo%> </h2>
                </div>
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-radius: 16px; " class=" max-h-9 flex-row hover:bg-neutral-600/50  hover:rounded-md " onclick="reproducirCancion('<%= datosCan[i][3]%>')">
                                        ...
                                        <td class="  whitespace-nowrap px-6 py-4"><p class="text-xl font-bold"><% out.print(datosCan[i][1]); %></p><a onclick='abrirCasoDeUso("consultarUsuario.jsp", "<%= datosCan[i][8]%>");' class=" hover:underline text-white cursor-pointer pr-2 "><p><%= datosCan[i][7]%></p></a></td>

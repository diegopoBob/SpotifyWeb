                                ...
                                <tr style="border-radius: 16px;" 
                                    ...
                                    <td class=" px-15 py-4">
                                        ...
                                        <p class="cursor-pointer hover:underline z-50"> 
                                            ...
                                            <a class="z-50" onclick='abrirCasoDeUso("consultarUsuario.jsp", "<%= datosCan[i][8]%>")' class="hover:underline w-1/6 text-white cursor-pointer pr-2"><%= datosCan[i][7]%> <%= datosCan[i][10] != null ? " " + datosCan[i][10] : "" %></a>
                                            <% } %>                                            </p>
                                    </td>

                ...
                <div class="p-4 md:p-5">
                    ...
                    <form action="cambiarEstadoSubscripcion" method="POST">
                        <ul class="space-y-4 mb-4">
                            <!-- Plan de 12 meses -->
                            <li>
                                <input type="radio" id="plan-12" name="planSub" value="12" class="hidden peer" required />
                            ...
                            <!-- Plan de 6 meses -->
                            <li>
                                <input type="radio" id="plan-6" name="planSub" value="6" class="hidden peer" />
                            ...
                            <!-- Plan de 1 mes -->
                            <li>
                                <input type="radio" id="plan-1" name="planSub" value="1" class="hidden peer" />
